...
SetupIconFile=c:\msil\prj.ico
;AlwaysCreateUninstallIcon=yes
LicenseFile=c:\occil\License.txt
;BackColor=clRed
;BackColor2=clAqua
;WindowVisible= yes
AppCopyright=Copyright(C) LADSoft 2016-2018, All Rights Reserved.
WizardSmallImageFile=c:\occil\ladsoft1.bmp
WizardImageFile=c:\occil\ladsoftl.bmp
...
[Messages]
BeveledLabel=Orange C MSIL, Copyright (C) LADSoft, 2016-2018
